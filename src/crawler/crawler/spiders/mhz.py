...
class MhzSpider(scrapy.Spider):
    name = 'mhz'
    allowed_domains = ['mhz.de']

    def __init__(self, *args, **kwargs):
        super(MhzSpider, self).__init__(*args, **kwargs)
        self.start_url = "http://mhz.de/"
    ...
    def parse_products(self, response):
        ...
        main_navigation = response.css("div#mainnavigation")
        product_menu = main_navigation.css("ul.navbar-nav li.main-link:first-child")
